# include "LiquidCrystal.h"
    ...
    /* print_long
     * --------------
     * Print a long number (signed or unsigned) 
     */
    void print_long(long num)
    {
        char s_num[80];             // array of char
        sprintf(s_num, "%ld", num); // create string, receive long data type
        print(s_num);               // use print function
    }
